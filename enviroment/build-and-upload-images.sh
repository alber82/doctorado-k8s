...
docker build --platform linux/arm64  --build-arg VERSION=0.0.0 -t 192.168.1.229:5000/doctorado/nginx-fibonacci:0.0.0 -f tests/nginx-fibonacci/Dockerfile .
docker push 192.168.1.229:5000/doctorado/nginx-fibonacci:0.0.0

docker build --platform linux/arm64  --build-arg VERSION=0.0.0 -t 192.168.1.229:5000/doctorado/disk-test:0.0.0 -f tests/disk-test/Dockerfile .
