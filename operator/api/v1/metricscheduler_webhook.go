...
func (r *MetricScheduler) ValidateCreate() (admission.Warnings, error) {
...
func (r *MetricScheduler) ValidateUpdate(old runtime.Object) (admission.Warnings, error) {
...
func (r *MetricScheduler) ValidateDelete() (admission.Warnings, error) {
